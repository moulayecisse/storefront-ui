  ...
  .add("How to use Storybook", () => ({
    ...
    <div class="intro">
      ...
      <p>
        ...
        You can use the <b>Knobs panel</b> to play with the Props and CSS modifiers of each component.
        Components marked as <i>WIP</i> will much likely change and they are not safe to use.
        On the <b>Notes</b> panel you will find additional information about components. This information consistes of available SCSS variables and other things.
      </p>
      <p>
        <b>StorefrontUI is currently in <b>ALPHA</b>, which means it is not suitable for production! Expect things to be broken and expect APIs to change.</b>
      </p>
      <h2>Join us!</h2>
        <p>StorefrontUI is a completely new approach for component libraries oriented around customization possibilities instead of out of the box possibilities. 
        It's a great goal but it will take a lot of time to achieve it by ourselves. The project is open source and free to use. 
        If you'd like to support us and join the team please write to me: <b>filip [at] vuestorefront.io</b> ;)
        </p>
      <h2>How to start?</h2>
      <ol>
      ...
      <ul>
        ...
        <li>Standard component customization with filling Props</li>
